package com.keyansys.hibernate.dao;
...
//import com.keyansys.hibernate.beans.Notice;
...
public class UserDAO extends HibernateDaoSupport implements IUserDAO {
	...
	public void savePartData(String password,String username)
		...
		try {
			Query query=session.createQuery("update User u set u.password=? where u.userName=?");
	...
	public void saveWorkloadLevel(String workloadLevel,String positionalTitles)
		...
		Session session=this.getSession();
		try {
			Query query=session.createQuery("update User u set u.workloadLevel=? where u.positionalTitles=?");
