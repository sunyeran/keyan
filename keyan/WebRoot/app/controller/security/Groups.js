Ext.define('keyan.controller.security.Groups', {
    ...
    onButtonClickAdd: function (button, e, options) {
    	...
    	var model = Ext.create('keyan.model.security.Group', {
    		id: 0,
    		name: null
    	});
			     		...
			     		Ext.Ajax.request({
                            ...
                            success: function(conn, response, options, eOpts) {
                                ...
                                if (result.success) {
                                    ...
                                    keyan.util.Alert.msg('Success!', 'Group deleted.');
                                    store.load();
                                    form.reset();
	        	...
	        	Ext.Ajax.request({
	                ...
	                success: function(conn, response, options, eOpts) {
	                    ...
	                    if (result.success) {
	                        ...
	                        keyan.util.Alert.msg('Success!', 'Group saved.');
                            store.load();
                            formPanel.setDisabled(true);
