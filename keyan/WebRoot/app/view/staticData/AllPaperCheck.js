Ext.define('keyan.view.staticData.AllPaperCheck', {
    extend: 'keyan.view.staticData.AbstractAllKeyanGrid',
    alias: 'widget.allpapercheckgrid',
   ...
   store: 'staticData.PaperCheck',
     /*  features: [Ext.create('Ext.grid.feature.GroupingSummary', 
		...
		groupByText: '用本字段分组', 
		showGroupsText: '显示分组', 
		groupHeaderTpl: '所属部门: {department} ({rows.length})', //分组显示的模板 
   ...
   features: [{
        groupHeaderTpl: '部门: {department}'},
        {ftype: 'groupingsummary'}],*/
       columns: [
       //添加下列显示序号语句将引起多个tab标签打开再关闭再打开标签出现：“TypeError: l.getRenderTarget(...).dom is undefined”错误
