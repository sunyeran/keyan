...
public class UploadFile extends HttpServlet {
	...
	String projectpath = this.getServletContext().getContextPath();//.getRealPath("upload") ;
	projectpath=projectpath+"/"+department+"/"+user+"/";
	//String projectpath = "e:\\upload" +  File.separator + department+  File.separator +user
	//		+ File.separator;
			...
			if(!item.isFormField()){
				...
				if(!("".equals(fileName))&&!(fileName==null)){
					...
					try {
						...
						photo.setContent_type(filepath);
